...
if(isset($_POST))
{
    ...
    $DestinationDirectory   = '/Applications/XAMPP/xamppfiles/htdocs/campus_freelancer/uploads/'; //Upload Directory ends with / (slash)
...
function resizeImage($CurWidth,$CurHeight,$MaxSize,$DestFolder,$SrcImage,$Quality,$ImageType)
{
    ...
    // Resize Image imagecopyresampled — Copy and resize part of an image with resampling
